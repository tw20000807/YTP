...
class ArrayVisualizer extends BaseVisualizer {
    ...
    getParams() {
        return { base: this.base, limit: this.limit, indexLabel: this.indexLabel, dataFields: this.dataFields.map(d => ({ fieldName: d.fieldName, nickname: d.nickname })) };
    }

    /** Restore state. Does NOT render — caller invokes update() afterwards. */
    setParams({ base, limit, indexLabel, dataFields } = {}) {
        if (base !== undefined) {
